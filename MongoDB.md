...
```
==注意点1！！！！==
==mongodb从数据库变为主数据库的选举方式，假如有10个数据库，主数据库挂了，那么一般会从最后一个选举，但存在网络问题等，则会择优选取前一个，以此类推，当整个服务器只还有1个服务工作室，mongodb出于保护，最后一个服务将不会选举为主服务，不对外开放!所以我们mongodb必须要保证最少有2个服务载运行 #800000==
...
![enter description here][9]
  ...
  [9]: ./images/QQ%E6%88%AA%E5%9B%BE20180205000129.png "QQ截图20180205000129"
